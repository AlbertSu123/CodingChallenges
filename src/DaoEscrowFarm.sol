...
//  *   This would require the DaoEscrowFarm contract to have a sizable and unrealistic amount of ETH. However, if we can assume that this contract has a near infinite amount of ETH:
//  *
...
//         // To set maxDeposit to less than 1 Ether, send 0.5 eth, reenter, send 0.6 eth
//         console.log("msg.value: %s, maxDeposit: %s", msg.value, maxDeposit);
//         if (msg.value > maxDeposit) {
//             // refund user if they are above the max deposit allowed
//             uint256 refundValue = maxDeposit - msg.value;
//             // Make this negative somehow, ie if we get msg.value > maxDeposit our balance goes to infinity
//             console.log("Refund Value: %s", refundValue);
//             console.log("Current Balance %s", address(this).balance);
//             (bool success, ) = msg.sender.call{value: refundValue}("");
//             console.log("Success: %s", success);
//             require(success, "ETH_TRANSFER_FAIL");

//             prev.balance -= refundValue;
//             console.log("Balance in Max: %s", prev.balance);
//         }

//         prev.balance += msg.value;
//         prev.blockDeposited = block.number;
//         console.log("Balance: %s", prev.balance);
//     }
